const AboutSection = () => {
  return (
    <section id="about" className="py-20 sm:py-24 relative overflow-hidden bg-navy">
      {/* Flame effect background */}
      <div className="hidden md:block absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-fire-lava/20 via-secondary/10 to-transparent rounded-full blur-3xl" />
      <div className="hidden md:block absolute top-20 right-20 w-64 h-64 bg-gradient-to-bl from-fire-gold/10 via-secondary/10 to-transparent rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold fire-gradient mb-6 sm:mb-8 text-center lg:text-left animate-in fade-in slide-in-from-left duration-700">
            About Us
          </h2>

          <p className="text-base sm:text-xl text-secondary/80 mb-8 tracking-wider uppercase text-center lg:text-left animate-in fade-in slide-in-from-left duration-700 delay-100">
            Forged in the heat of curiosity, refined through relentless collaboration.
          </p>

          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-10 items-start">
            <div className="space-y-6 text-base sm:text-lg text-white/90 leading-relaxed text-center lg:text-left animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
              <p>
